...
Original file is located at
    https://colab.research.google.com/drive/1Wovw0Hlfc5oJyq0ktzIameN6cbpMDZH4
...
avg_stroke = np.mean(pd.to_numeric(df['stroke']))
print(f"Average of stroke: {avg_stroke}")
...
# Write your code below and press Shift+Enter to execute
df = df.assign(highway_L_per_100km=235 / df['highway-mpg'])
df.head()
...
# dropping the original aspiration column
...
# Load the notebook
notebook_path = "/content/drive/MyDrive/Spring2025/Mid-termexam/Codes/Exam1Part1-Starter.ipynb"
output_html_path = "/content/drive/MyDrive/Spring2025/Mid-termexam/mid-termhtml/part1html/exampart1.html"
